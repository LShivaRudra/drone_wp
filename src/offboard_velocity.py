...
def main():
    ...
    sv_pub = rospy.Publisher('setpoint_vel', PositionTarget, queue_size=10)
    ...
    vel_cmd.header = 'base_link'
    vel_cmd.type_mask = 0b0000101111000011

    vel_cmd.position.x = 0
    vel_cmd.position.y = 0
    vel_cmd.position.z = 1.0

    vel_cmd.velocity.x = 1.0
    vel_cmd.velocity.y = 0.0
    vel_cmd.velocity.z = 0.0

    sv_pub.publish(vel_cmd)
    rate.sleep()
